...
def interference_loss(N):
    ...
    switch_time = 2e-11 #20 picoseconds for the rise time , etc
   ...
   #     print("bot array:",bottom_array)
    ...
    return  (1-average_loss)*100
    # Define the range of N values you want to compute the loss for
N_values = [4,6,8,10,12,16,20,24,30, 34,40, 44,50,54,60,64,70,74,80,84,90,94,100,140,200,240,300,340,400,440,500]

# Calculate interference loss for each N value
loss_results = {}
for N in N_values:
    loss_results[N] = interference_loss(N)

# Save results to a text file
with open("avgLoss05HighMZI.txt", "w") as file:
